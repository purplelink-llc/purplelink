// /moderntex/success/ — turn a paid Stripe session into download links.
// Calls moderntex-download in list mode, then renders one button per entitled file.
(function () {
  ...
  fetch("/.netlify/functions/moderntex-download?session_id=" + encodeURIComponent(sessionId))
